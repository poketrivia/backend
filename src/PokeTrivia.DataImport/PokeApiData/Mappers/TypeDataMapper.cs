...
{
    public static class TypeDataMapper
    {
        public static List<TypeData> GetTypes()
        {
            var directoryEntries = ApiDataFileSystem.FileSystem.EnumerateDirectoryEntries("/type");
            ...
            return ApiDataDeserializer.DeserializeData<TypeData>(files).ToList();
        }
    }
}